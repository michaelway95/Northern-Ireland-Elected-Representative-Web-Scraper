...
public class NIAWebScraper
{
    ...
    formal parameters
     */
    private String stringFromFirstElementSiblingIfExists(Document webpage, String elementCSS)
    {
        //declaring Elements tempElements for each instance of the css selector in the webpage
        Elements tempElements = webpage.select(elementCSS);
     ...
     */
    private String stringFromLastElementSiblingIfExists(Document webpage, String elementCSS)
    {
        //declaring Elements tempElements for each instance of the css selector in the webpage
        Elements tempElements = webpage.select(elementCSS);
     ...
     */
    private String emailFromFirstElementSiblingIfExists(Document webpage, String elementCSS)
    {
        //declaring Elements tempElements for each instance of the css selector in the webpage
        Elements tempElements = webpage.select(elementCSS);
     ...
     */
    private String emailFromLastElementSiblingIfExists(Document webpage, String elementCSS)
    {
        //declaring Elements tempElements for each instance of the css selector in the webpage
        Elements tempElements = webpage.select(elementCSS);
